...
<head>
    ...
    {{HTML::style('assets/css/eW.css')}}
    {{HTML::style('assets/css/jquery-ui.css')}}
    {{HTML::style('assets/css/jquery-ui.theme.css')}}
    {{HTML::style('assets/css/jquery-ui.structure.css')}}
    {{HTML::style('assets/css/timepicker.css')}}	
